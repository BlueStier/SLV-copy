...
const CONF: vscode.WorkspaceConfiguration =
  vscode.workspace.getConfiguration("SLV-copy");
...
let filePathVsCode =
  process.env.APPDATA?.charAt(0).toLowerCase() + process.env.APPDATA?.slice(1)!;
